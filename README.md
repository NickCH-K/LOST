THIS REPO IS MOVING TO https://github.com/LOST-STATS/LOST-STATS.github.io
NO NEED TO EDIT THIS REPO ANY MORE
...
How can you add these images? You can upload the images somewhere on the internet that allows image linking, and [include the image in your instructions](https://help.github.com/en/articles/editing-wiki-content). Or, ideally, if you know how to use GitHub, you can issue a [Git Pull Request](https://help.github.com/en/articles/creating-a-pull-request) to upload the images to the LOST/Pictures/NameofPage folder, and link to the images there. Alternately, post in Issues asking for collaborator status so you can upload directly without doing a Pull Request.

Please be sure to add alt text to images for sight-impaired users.

**Data**

*Ideally*, the same data set will be uploaded to LOST directly in a format accessible by many languages (like CSV) in the `Data/name-of-your-page/` folder, and then that data can be used for implementation in all languages on the page. This is not required, but is encouraged. 

How can you upload data? You can use a [Git Pull Request](https://help.github.com/en/articles/creating-a-pull-request) to upload a data set. Alternately, post in Issues asking for collaborator status so you can upload directly without doing a Pull Request. 
